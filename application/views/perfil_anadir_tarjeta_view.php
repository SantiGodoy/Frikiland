<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-12 col-lg-10 mt-5">
            ...
            echo form_open(site_url('perfil/anadirTarjeta/'));
            ...
            echo '<div class="col-12">';
            echo '<input type="text" name="cvv" class="form-control" id="staticCVV" >';
            echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-12">';
            echo '<input type="date" name="fechaCaducidad" class="form-control" id="staticFechaCaducidad" >';
            echo '</div>';
            echo '</div>';
            ...
            echo '<div class="col-12">';
            echo '<input type="text" name="marca" class="form-control" id="staticMarca" >';
            echo '</div>';
            echo '</div>';


            echo '<button class="btn float-right btn-primary col-12" type="submit">AÑADIR</button>';
            echo '<a class="btn float-right btn-secondary col-12 mt-3" href="' . site_url('perfil/tarjetas') . '">VOLVER ATRÁS</a>';
